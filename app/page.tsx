  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        id="presentation"
        style={{
          background: `url('https://www.dropbox.com/scl/fi/3iyuq7nbghq03mrldei2x/unnamed-2025-09-07T222151.578.png?rlkey=z7cr3f7htlf225yfl59mdy7yb&st=7uc6o97w&dl=1') center/cover no-repeat`,
        }}
      >
        <div className="container mx-auto px-6">
